...
census_tracts_df <- st_drop_geometry(census_tracts_eji)  %>% 
  distinct()
...
ggsave("all census tracts with ppps boxplots_salvatore.png", width = 18, height = 10, units = "in")
...
ggsave("all census tracts with ppps boxplots for diff variables_salvatore.png", width = 18, height = 20, units = "in")
...
ggsave("all census tracts with ppps boxplots by dataset.png", width = 18, height = 15, units = "in")
